...
| `secure-coding-plugin` | 1.0.0 | 스킬 5종 | 한국 전자정부 SW 개발보안(시큐어코딩) 공식 가이드 레퍼런스 |
...
한국 전자정부 소프트웨어 개발보안(시큐어코딩) 공식 가이드 6종을 근거로 한 레퍼런스 스킬 5종을 제공합니다. 코드 진단/리뷰, 안전한 코드 작성, 검증 절차 대응에 사용합니다.
